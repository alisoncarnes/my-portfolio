    ...
    return (
        <div className="container">
          ...
          <h2>Resume</h2>
            ...
            <div className="row">
              <div className="col">
              I am a software engineer who is interested in leveraging full stack web development and industry leading design tools and technologies to build user-centric products.
              </div>
              <div className="col">
              Email: <a href="mailto:alisoncarnes@gmail.com">alisoncarnes@gmail.com</a><br/>
              GitHub: <a href="https://github.com/alisoncarnes">@alisoncarnes</a> <br/>
              LinkedIn: <a href="https://www.linkedin.com/in/alison-carnes-a7100b119/">@alison-carnes-a7100b199</a> <br/>
              </div>
            </div>
            <div className="empty-div"/>
            ...
            <div className="row">
              <div className="col">
              <h4>Languages:</h4> <br/>
              <b>JavaScript, HTML, CSS, PHP, SQL</b>

              </div>
              <div className="col">
              <h4>Frameworks:</h4> <br/>
              <b>React.js, MongoDB, API/Rest APIs, Mongoose ODM, Node.js, GitHub, jQuery</b>
              </div>
            </div>
            <div className="empty-div"/>
            <h4>Work Experience:</h4>
            <div className="empty-div"/>
            <h5>Practice of Dr. Steven Shimoyama</h5>
